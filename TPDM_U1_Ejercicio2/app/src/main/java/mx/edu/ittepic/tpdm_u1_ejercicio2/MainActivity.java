...
public class MainActivity extends AppCompatActivity {
    ...
    public void guardarEnArchivo(View v){
        String data = n.getText().toString()+"&"+d.getText().toString()+"&"
                +e.getText().toString()+"&"+s.getText().toString();
        try{
            OutputStreamWriter archivo =
                    new OutputStreamWriter(openFileOutput(nombreArchivo,MODE_PRIVATE));
            archivo.write(data);
            archivo.close();
